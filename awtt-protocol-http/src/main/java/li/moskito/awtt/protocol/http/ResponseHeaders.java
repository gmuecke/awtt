 ...
 * @author Gerald
 */
public enum ResponseHeaders implements HeaderFieldDefinition {
    ...
    private ResponseHeaders(final String headerFieldName) {
     ...
     * @return
     */
    public static ResponseHeaders fromString(final String string) {
        for (final ResponseHeaders field : values()) {
